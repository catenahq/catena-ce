...
Implemented in: `ansible/playbooks/backup.yml`, `ansible/reconcile/roles/backup`, `ansible/scripts/catena-restic-key.py`, `ansible/scripts/disk-preflight.sh`
...
| Managed updates with automatic rollback | 7 | 7 |
